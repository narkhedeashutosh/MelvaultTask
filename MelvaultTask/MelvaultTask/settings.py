"""
Django settings for MelvaultTask project.
...
SECRET_KEY = 'a!ky*jldegy#wx+woha*n#77@%0960csbr%8y2ngf3adz%98w3'
...
ROOT_URLCONF = 'MelvaultTask.urls'
...
WSGI_APPLICATION = 'MelvaultTask.wsgi.application'
